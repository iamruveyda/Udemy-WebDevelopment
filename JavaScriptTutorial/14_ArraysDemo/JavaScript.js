...
/* Aşağıda verilen elemanları bir dizi içerisinde saklayınız.
     ...
     studentA : Ayşe Bilgili 2010
     StudentB : Sena Bilgili 1999
     studentC : Duru Bilgili 1998   

*/

var studentA = ['Ayşe', 'Bilgili ', 2002];
var studentB = ['Sena', 'Bilgili ', 2000];
var studentC = ['Duru', 'Bilgili ', 1998];
